    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('apartments.update', $apartments->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="price"><b>Price:</b></label>
                            <input type="text" name="price" class="form-control" id="price" value="{{ $apartments->price }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{ asset('admin/assets/images/apartments/' . $apartments->image) }}" alt="car Image" class="img-thumbnail">
                        </div>
