        ...
        <div class="row bg-light">
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card card-hover">
                    <a href="{{ route('indonesiadetails') }}">
                        <img src="{{asset('images/indo.png')}}" class="img-fluid card-img-topp" alt="Card 1">
                    </a>
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card card-hover">
                    <a href="{{ route('indonesiadetails2') }}">
                        <img src="{{asset('images/indoo.png')}}" class=" img-fluid card-img-topp" alt="Card 2">
                    </a>
                    <div class="card-body">
