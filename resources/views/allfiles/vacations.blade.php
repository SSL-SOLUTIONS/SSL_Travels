...
<head>
    ...
    <link rel="stylesheet" href="{{asset('website/vacation/style.css')}}">
    <title>SSL Travels & Tours</title>
</head>
@include('allfiles.nav')
<body class="full-bg">
    <div>
        <img class="img-fluid" width="100%" src="{{asset('website/vacation/images/lower-kachura-or-shangrila-lake.jpg')}}" alt="">
    </div>
    <div>
        <h2 style="font-weight: bold;" class="text-center mt-5 mb-4 text-bold">Vacations</h2>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
                <div class="image container bg">
                    <img class="img-fluid" src="{{asset('website/vacation/images/imig.jpg')}}" alt="">
                    <h5 style="font-weight: bold;" class="mt-3">1 Day KhanPur Dam</h5>
                    <p class="">KhanPur Dam,KPK</p>
                    <hr>
