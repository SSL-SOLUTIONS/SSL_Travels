...
<body class="about-bg">
    ...
    <div class="card card-hover">
        <a href="{{ route('italydetails') }}">
            <img src="{{asset('images/Europe Group Tour.jpg')}}" class="img-fluid card-img-topp" alt="Card 1">
        </a>
        <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                    ...
                    <a href="{{ route('italydetails2') }}">
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="card-title" style=" color:black;">$3,412.00</h3>
                            <ul style=" color:black;">
                                <li>Schengen Visa Support</li>
                                <li>Daily Breakfast</li>
                                <li>Return Air Ticket (Lahore—Barcelona & Paris—Lahore)</li>
