...
<body class="about-bg">
    ...
    <div class="card card-hover">
        <a href="{{ route('greecedetails') }}">
            <img src="{{asset('images/4-post-tour.png')}}" class="img-fluid card-img-topp" alt="Card 1">
        </a>
        <div class="card-body">
            <h3 class="card-title" style="font-weight: 700; color:black;">New Year in Europe</h3>
            <h3 class="card-title" style="color:black;">$4,400.00</h3>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card card-hover">
                <a href="{{ route('greecedetails3') }}">
                        <img src="{{asset('images/7-post-tour.jpg')}}" class=" img-fluid card-img-topp" alt="Card 2">
                        </a>
                        <div class="card-body">
                            <h3 class="card-title" style="font-weight: 700;  color:black; ">Group Tour To Europe</h3>
                            <h3 class="card-title" style=" color:black;">$3,145.00</h3>
                            <ul style=" color:black;">
                                <li>Schengen Visa Support</li>
                                <li>Daily Breakfast</li>
                                <li>Return Air Ticket (Lahore—Barcelona & Paris—Lahore)</li>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                    <div class="card card-hover">
                <a href="{{ route('greecedetails4') }}">
                        <img src="{{asset('images/2-post-tour.png')}}" class="img-fluid card-img-topp" alt="Card 2">
                </a>
                        <div class="card-body">
                            <h3 class="card-title" style="font-weight: 700;  color:black; ">Group Tour To Europe</h3>
