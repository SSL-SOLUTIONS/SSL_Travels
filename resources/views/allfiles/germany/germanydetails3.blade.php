...
<body class="about-bg">
    ...
    <div class="container">
        <div class="row row-bg-light">
            <div class="col-lg-6">
                <img class="img-fluid" src="{{asset('images/3-post-tour.png')}}" alt="#" style="height:350px;">
            </div>
            <div class="col-lg-6" style="margin-bottom: 20px; position:relative; left:20px;">
                <h3 class="card-title" style="font-weight: 700;">Europe 4 In 1 Group Tour </h3><br>
                <h3 class="card-title" style="font-weight: 700;">$3,875.00</h3><br>
                <ul>
