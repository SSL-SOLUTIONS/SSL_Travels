...
<body class="about-bg">
    ...
    <div class="container">
        <div class="row row-bg-light">
            <div class="col-lg-6">
                <img class="img-fluid" src="{{asset('images/9-post-tour.jpg')}}" alt="#" style="height:350px;">
            </div>
            <div class="col-lg-6" style="margin-bottom: 20px; position:relative; left:20px;">
                <h3 class="card-title" style="font-weight: 700;">New Year Royal Caribbean Cruise in Singapore</h3><br>
