    ...
    <body class="about-bg">
        ...
        <div class="container" style="margin-top: 100px; margin-bottom:10px;">
            ...
            <div class="row bg-light">
                <div class="col-lg-6">
                    <img class="img-fluid" src=" {{asset('images/8-post-tour.jpg')}}" alt="#" style="height:350px;">
                </div>
                <div class="col-lg-6" style="margin-bottom: 20px; position:absolute; left:500px">
                    <h3 class="card-title" style="font-weight: 700;">Singapore Royal Caribbean Cruise Tour</h3><br>
                    <h3 class="card-title" style="font-weight: 700;">$2,411.00</h3><br>
